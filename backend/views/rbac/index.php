...
<table class="table table-bordered display" id="example">
   ...
   <?php foreach ($model as $rbac):?>
       <tr>
           ...
           <td>
               <?=\yii\bootstrap\Html::a('修改',['rbac/edit-permission','name'=>$rbac->name],['class'=>'btn btn-success'])?>
               <?=\yii\bootstrap\Html::a('删除',['rbac/del-permission','name'=>$rbac->name],['class'=>'btn btn-danger'])?>
           </td>
       </tr>
   <?php endforeach;?>
   </tbody>
